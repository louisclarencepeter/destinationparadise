...
export const tourActivities = {
  ...
  sandbankPicnic: [
    ...
    "Snorkel in calm, shallow waters",
    "Enjoy a seafood picnic",
  ],
  kizimkaziFishing: [
  ...
  nungwiTrip: [
    "Explore Nungwi village",
    "Visit dhow-building workshops",
    "Relax on stunning beaches",
    "Enjoy local cuisine",
  ],
  quadAdventure: [
    "Quad biking through local villages",
    "Visit to The Rock Restaurant",
    "Sunset viewing",
    "Educational tour of a local school"
  ],
  sunsetTrip: [
    "Visit to The Rock Restaurant",
    "Sunset viewing at Michamvi Beach",
    "Relax and enjoy the evening ambiance"
  ],
  sunsetSailing: [
