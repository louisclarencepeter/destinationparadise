const safariData = [
  {
    ...
    imageUrl: "/images/safari-1.jpg",
    shortDescription:
      "The Serengeti is famous for its vast savannahs, abundant wildlife, and the Great Migration...",
    fullDescription:
  ...
  },
  {
    ...
    imageUrl: "/images/safari-2.jpg",
    shortDescription:
      "A UNESCO World Heritage Site, Ngorongoro Crater is a breathtaking natural wonder...",
    fullDescription:
  ...
  },
  {
    ...
    imageUrl: "/images/safari-3.jpg",
    shortDescription:
      "Known for its large elephant herds and ancient baobab trees, Tarangire National Park...",
    fullDescription:
  ...
  },
  {
    ...
    imageUrl: "/images/safari-4.jpg",
    shortDescription:
      "Lake Manyara is famous for its tree-climbing lions, large troops of baboons...",
    fullDescription:
  ...
  {
    title: "Selous Game Reserve (Now Nyerere National Park)",
    imageUrl: "/images/safari-5.jpg",
    shortDescription:
      "As one of Africa's largest game reserves, Selous (Nyerere) offers a remote and uncrowded...",
    fullDescription:
  ...
  },
  {
    ...
    imageUrl: "/images/safari-6.jpg",
    shortDescription:
      "For those looking for an off-the-beaten-path safari, Ruaha is an excellent choice...",
    fullDescription:
  ...
  },
  {
    ...
    imageUrl: "/images/safari-7.jpg",
    shortDescription:
      "Often considered a smaller version of the Serengeti, Mikumi National Park...",
    fullDescription:
  ...
  {
    title: "Mahale Mountains & Gombe Stream National Park",
    imageUrl: "/images/safari-8.jpg",
    shortDescription:
      "For an extraordinary safari experience, Mahale Mountains and Gombe Stream National Park...",
    fullDescription:
  ...
  },
  {
    ...
    imageUrl: "/images/safari-9.jpg",
    shortDescription:
      "One of Tanzania's most untouched and least visited parks, Katavi offers a true wilderness...",
    fullDescription:
  ...
  },
  {
    ...
    imageUrl: "/images/safari-10.jpg",
    shortDescription:
      "Saadani is the only national park in Tanzania where the bush meets the beach...",
    fullDescription:
