      ...
      <div className='testimonials'>
        ...
        <Slide>
          <div className="review">
            <div className='namestars'> <img src={img1} alt="" />
              <div><p>Isa Jua</p><Stars count={5} /></div>
            </div>
            <div>
          ...
          <div className="review">
            <div className='namestars'> <img src={img2} alt="" />
              <div><p>Isa Jua</p><Stars count={5} /></div>
            </div>
            <div >
          ...
          <div className="review">
            <div className='namestars'> <img src={img3} alt="" />
              <div><p>Isa Jua</p><Stars count={5} /></div>
            </div>
            <div >
