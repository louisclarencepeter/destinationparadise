      ...
      <div className="contact__grid">
        <aside className="contact__details">
          ...
          <div className="contact__detail">
            ...
            <a className="contact__detail-value" href={CONTACT_INFO.whatsappUrl} target="_blank" rel="noreferrer">{t('contact.details.whatsapp_action')}</a>
          </div>
          <div className="contact__detail">
            <span className="contact__detail-label">
              <svg className="contact__detail-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        ...
        <form className="contact__form" onSubmit={onSubmit}>
          ...
          <label className="contact__field">
            ...
            <input type="text" name="subject" placeholder={t('contact.form.subject_placeholder')} value={form.subject} onChange={update('subject')} />
          </label>
          <label className="contact__field">
          ...
          >
            {status === 'sending' ? t('contact.form.submit_pending') : status === 'sent' ? t('contact.form.submit_done') : t('contact.form.submit')}
            <ArrowIcon size={16} />
          </button>
        </form>
      </div>
