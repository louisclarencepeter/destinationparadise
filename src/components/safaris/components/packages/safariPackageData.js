...
const safariPackages = [
  {
    ...
    sharedPrices: {
      budget: "$1,600 per person",
      midRange: "$2,200 per person",
      luxury: "$3,700 per person",
    },
    privatePrices: {
      budget: "$1,900 per person",
      midRange: "$2,500 per person",
  ...
  },
  {
    ...
    sharedPrices: {
      budget: "$2,200 per person",
      midRange: "$3,000 per person",
  ...
  },
  {
    ...
    sharedPrices: {
      midRange: "$1,300 per person",
      luxury: "$2,500 per person",
    },
    privatePrices: {
      midRange: "$1,500 per person",
      luxury: "$2,800 per person",
