...
var Assistants = class extends APIResource {
   ...
   * ```
   */
  retrieve(assistantId2, options) {
    return this._client.get(`/assistants/${assistantId2}`, {
      ...options,
      headers: { "OpenAI-Beta": "assistants=v2", ...options?.headers }
    });
  }
   ...
   * ```
   */
  update(assistantId2, body, options) {
    return this._client.post(`/assistants/${assistantId2}`, {
      body,
      ...options,
      headers: { "OpenAI-Beta": "assistants=v2", ...options?.headers }
    });
   ...
   * ```
   */
  del(assistantId2, options) {
    return this._client.delete(`/assistants/${assistantId2}`, {
      ...options,
      headers: { "OpenAI-Beta": "assistants=v2", ...options?.headers }
    });
  }
...
var assistantId = "asst_vDBb5Rc2RZ8sLD6gf0uCxPl0";
