...
**11 September 2026 disclosure clarification:** Signed iOS 1.1.1/build 7 and Android 1.1.1/code 10 are complete and private at EAS. iOS reduced accuracy is a default that users may override in Settings; the source policy now explains that and three-decimal rounding. The exact current-to-proposed [location declarations](LOCATION_DECLARATIONS_2026-09-11.md) supersede the earlier country-only rationale and open-ended assessment. Apple remains 1.1.0/build 6 Waiting for Review; no replacement is uploaded. Google Advertising ID=No was saved; it is not submitted or approved. Personalization was also saved for Google Approximate location collection and sharing, preserving Required, non-ephemeral and existing purposes. Apple declaration changes remain proposed; Apple UI currently requires owner sign-in. The clarification is not yet published.
